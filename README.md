...
| `VT-Cache.ps1` | Moduł cache wyników VirusTotal (RAM + dysk) |
| `Send-CollectorAlert.ps1` | Zunifikowany moduł alertów – Discord, e-mail, SIEM JSON |
| `Write-SecureLog.ps1` | Bezpieczny dziennik z łańcuchem HMAC-SHA256 |
| `CollectorAPI.ps1` | Centralny kolektor REST – odbiera zdarzenia SIEM z wielu hostów |
| `dashboard.html` | Dashboard HTML/JS do wizualizacji logów i alertów |
| `README.md` | Dokumentacja projektu (Total Edition) |
| `README_ULTRAMASTER.md` | Dokumentacja edycji ULTRAMASTER Full Suite |
