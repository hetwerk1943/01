...
- **Node.js** (opcjonalnie, do serwowania dashboardu przez `http-server`)

---

## 🔹 Uruchomienie dashboardu (http-server)

Możesz serwować dashboard lokalnie za pomocą `http-server`:

```bash
# Instalacja http-server (jednorazowo)
npm install -g http-server

# Lub przy użyciu lokalnych zależności projektu
npm install

# Uruchomienie serwera (otwiera dashboard.html automatycznie)
npm start
...
Dashboard będzie dostępny pod adresem: **http://localhost:8080/dashboard.html**
